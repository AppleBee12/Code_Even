...
(2, NULL, 0, 2, 'A0001', 'B0001', 'C0001', '', 'HTML/CSS : 기초부터 실전까지 올인원', 'HTML/CSS : 예제와 함께하는 기초부터 실전까지 html, css 올인원 과정', '이븐선생', 'https://youtu.be/oHTr2fEkmGA?si=fNAGT0cPExpzwXDM', NULL, 30, 'general', '', '', 1, 1, 90000, 50, '2024-11-20 02:50:16'),
...
CREATE TABLE `notice` (
  ...
  `content` text NOT NULL COMMENT '내용',
  `view` int(11) NOT NULL COMMENT '조회수',
  `regdate` date NOT NULL DEFAULT current_date() COMMENT '등록일',
  `status` enum('on','off') NOT NULL DEFAULT 'off' COMMENT '상태'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `class_data`
  MODIFY `cdid` int(11) NOT NULL AUTO_INCREMENT COMMENT '수강데이터ID', AUTO_INCREMENT=0;
...
--
ALTER TABLE `stuscores`
  ADD CONSTRAINT `stuscores_ibfk_1` FOREIGN KEY (`stu_id`) REFERENCES `user` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
