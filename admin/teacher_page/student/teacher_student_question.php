      ...
      if ($dataArr) {
        foreach ($dataArr as $no) {
          ...
          <tr>
            ...
            <td><?= $no->userid; ?></td>
            <td><?= $no->username; ?></td>
            <td><a href="http://<?= $_SERVER['HTTP_HOST']; ?>/code_even/admin/student/student_question_details.php?sqid=<?= $no->sqid; ?>" class="underline"><?= $no->qtitle; ?></a>
            </td>
            <td><?= $no->name; ?></td>
  ...
  <div class="list_pagination" aria-label="Page navigation example">
    <ul class="pagination d-flex justify-content-center">
      ...
      if ($block_num > 1) {
        ?>
        <li class="page-item">
          <a class="page-link" href="teacher_student_question.php?page=<?= $previous; ?>" aria-label="Previous">
      ...
      for ($i = $block_start; $i <= $block_end; $i++) {
        ...
        <li class="page-item <?= $active; ?>"><a class="page-link"
            href="teacher_student_question.php?page=<?= $i; ?>"><?= $i; ?></a></li>
        <?php
      }
      $next = $block_end + 1;
      if ($total_block > $block_num) {
        ?>
        <li class="page-item">
          <a class="page-link" href="teacher_student_question.php?page=<?= $next; ?>" aria-label="Next">
