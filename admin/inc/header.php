  ...
  <header class="header">
    ...
    <div>
      ...
      <ul class="nav nav-pills">
        <li class="nav-item">
          <a class="nav-link" href="#"><img src="http://<?= $_SERVER['HTTP_HOST']; ?>/code_even/images/sb_logo.png" alt="" width="50"></a>
        </li>
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="http://<?= $_SERVER['HTTP_HOST']; ?>/code_even/admin/login/logout.php">로그아웃</a></li>
          </ul>
        </li>
      </ul>
  ...
  <div class="nav_wrapper d-flex">
    <nav class="nav navbar-expand-lg d-flex flex-column justify-content-between">
      <ul class="list-group line">
        <li class="list-group-item active"><a href="http://<?= $_SERVER['HTTP_HOST']; ?>/code_even/admin/index.php"><i class="bi bi-grid"></i> 　 대시보드</a></li>
        ...
        <li class="pr list-group-item">
          ...
          <ul class="collapse btn-toggle-nav" id="lecture_collapse">
            ...
            <li class="list-group-item dropdown-item"><a href="http://<?= $_SERVER['HTTP_HOST']; ?>/code_even/admin/lecture/quiz_test_list.php"> 　 - 퀴즈 / 시험 목록</a></li>
            <li class="list-group-item dropdown-item"><a href="http://<?= $_SERVER['HTTP_HOST']; ?>/code_even/admin/lecture/quiz_test_outcome.php"> 　 - 퀴즈 / 시험 결과 관리</a></li>
          </ul>
        </li>
