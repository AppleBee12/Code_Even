      ...
      <table class="table info_table">
        <tbody>
          <tr>
            ...
            <td>
              <input type="text" id="userid" name="userid" class="form-control" placeholder="입력 필수 값 입니다."
                value="<?= $row['userid'] ?>" disabled readonly>
            </td>
            ...
            <td>
              <input type="text" id="contact" name="userphonenum" class="form-control" placeholder="입력 필수 값 입니다."
                value="<?= $row['userphonenum'] ?>">
          </tr>
          <tr>
            <th scope="row">
            ...
            <td>
              <input type="text" id="username" name="username" class="form-control" placeholder="입력 필수 값 입니다."
                value="<?= $row['username'] ?>">
            </td>
            <th scope="row">
            ...
            <td colspan="3">
              <input type="email" id="email" name="useremail" class="form-control w_512" placeholder="입력 필수 값 입니다."
                value="<?= $row['useremail'] ?>">
            </td>
          </tr>
