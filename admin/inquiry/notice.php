  ...
  <div class="container">
    ...
    <form action="" method="">
      <table class="table list_table">
        ...
        <tbody>
          <tr>
            ...
            <td>admin</td>
            <td>관리자</td>
            <td><a href="http://<?= $_SERVER['HTTP_HOST']; ?>/code_even/admin/inquiry/notice_details.php" class="underline">[공지] 결제요청 가이드라인 안내</a></td>
            <td>9,999</td>
            <td>2024/10/31</td>
            <td>
      ...
      <div class="d-flex justify-content-end gap-2">
        <button type="button" data-bs-toggle="modal" data-bs-target="#status_modal" class="btn btn-outline-secondary">상태일괄수정</button>
