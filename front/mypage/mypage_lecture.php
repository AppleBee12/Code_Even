      ...
      foreach ($groupedClasses as $lectureId => $classes):
        ...
        <div class="my_lecture mb-4">
          <div class="my_lec_top d-flex">
            <img
              src="<?= isset($classes[0]->lecture_image) ? htmlspecialchars($classes[0]->lecture_image) : 'default.jpg'; ?>"
              alt="강좌 이미지">
            <div class="d-flex flex-column justify-content-evenly">
              <p class="headt5">
                <?= isset($classes[0]->lecture_title) ? htmlspecialchars($classes[0]->lecture_title) : '강좌 제목 없음'; ?></p>
              <p>
                <b><?= isset($classes[0]->lecture_teacher) ? htmlspecialchars($classes[0]->lecture_teacher) : '강사명 없음'; ?></b>
                | <span>레시피강좌</span></p>
            </div>
          </div>
          <!-- 강좌 디테일 시작 -->
              ...
              <div class="my_lec_txt">
                <ul class="d-flex flex-column gap-2">
                  ...
                  <li class="d-flex gap-5 align-items-center">
                    ...
                    //echo $completionRate;
                    ?>
                    <div class="progress" role="progressbar" aria-valuenow="<?= $completionRate; ?>" aria-valuemin="0"
                      aria-valuemax="100">
                ...
                <div class="my_lec_btn d-flex mt-3 gap-2">
                  <button type="button" class="btn btn-outline-dark btn-sm" data-bs-toggle="modal"
                    data-bs-target="#howToGetCertificate">
                    수료기준
                  </button>
                  <!-- Modal -->
                  <div class="modal fade" id="howToGetCertificate" tabindex="-1"
                    aria-labelledby="howToGetCertificateLabel" aria-hidden="true">
              ...
              <div class="my_lec_graph_wrapper d-flex">
                <div class="my_lec_graph d-flex flex-column align-items-center">
                  <div class="donut-chart"
                    style="--percentage: <?= $completionRate = $totalLectures > 0 ? round(($completedLectures / $totalLectures) * 100) : 0; ?>%;">
              ...
              <?php foreach ($classes as $class): ?>
                <div class="d-flex justify-content-between align-items-center w-100 mb-3"> <!--한 강의 내용 -->
                  ...
                  <div class="goto_lec_btn">
                    <a href="http://<?= $_SERVER['HTTP_HOST']; ?>/code_even/front/lecture_detail.php?detail_id=<?= isset($class->detail_id) ? $class->detail_id : 0; ?>"
                      class="btn btn-secondary">강의보러가기</a>
                  </div>
                </div><!--한 강의 내용 끝-->
              <?php endforeach; ?>
