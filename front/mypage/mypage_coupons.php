...
<div class="mypage_tap_wrapper d-flex justify-content-between">
  ...
  <nav>
    <div class=" nav nav-underline headt6" id="nav-tab" role="tablist">
      <button class="mypage_tap nav-link active" id="nav-myLecTab1-tab" data-bs-toggle="tab" data-bs-target="#nav-myLecTab1"  role="tab" aria-controls="nav-myLecTab1" aria-selected="true">사용 가능한 쿠폰 (<?php echo $available_coupon_count; ?>)</button>
