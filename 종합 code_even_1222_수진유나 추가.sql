...
(22, 3, 57, NULL, NULL, '2024-12-19 22:44:01'),
...
(28, 3, 54, NULL, NULL, '2024-12-20 16:04:01'),
(29, 3, 56, NULL, NULL, '2024-12-21 19:07:44'),
(30, 3, 55, NULL, NULL, '2024-12-22 21:24:34');
...
(13, 29, 'PHP에서 변수의 데이터 타입을 변환하는 방법', '안녕하세요, PHP에서 변수의 데이터 타입을 변환하는 방법에 대해 궁금합니다. 예를 들어, 문자열을 정수로 변환하거나, 배열을 객체로 변환하는 방법이 있으면 알려주실 수 있나요? 또한, PHP에서 제공하는 타입 변환 함수에 대해서도 알고 싶습니다.', '2024-12-20 02:54:32'),
(14, 29, 'PHP에서 배열을 정렬하는 방법', 'PHP에서 배열을 오름차순 또는 내림차순으로 정렬하려고 하는데, 어떻게 하면 효율적으로 할 수 있는지 잘 모르겠습니다.\r\n\r\nsort()와 arsort() 함수의 차이점도 설명해 주실 수 있나요? 그리고 다차원 배열을 정렬하는 방법에 대해서도 알고 싶습니다.', '2024-12-20 02:55:53'),
(15, 29, 'PHP의 세션과 쿠키 차이점에 대해 설명해 주세요', 'PHP에서 세션(session)과 쿠키(cookie)의 차이점에 대해 헷갈리고 있습니다.\r\n\r\n세션은 서버에 저장되고 쿠키는 클라이언트에 저장된다고 들었는데, 실제로 언제 세션을 사용하고 언제 쿠키를 사용하는 게 좋은지, 각 방식의 장단점에 대해서도 설명 부탁드립니다.', '2024-12-20 02:56:32');
...
(1, 'code_even', '이븐관리자', '이븐이', '3627909a29c31381a071ec27f7c9ca97726182aed29a7ddd2e54353322cfb30abb9e3a6df2ac2c20fe23436311d678564d0c8d305930575f60e2d3d048184d79', '010-1234-5678', 'hong@example.com', 1, 45617, '서울특별시 강남구', '101호', NULL, '2024-01-01', '2024-12-22 21:47:39', 100, 0),
