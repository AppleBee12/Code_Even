...
(11, 15, 0, '<p>일단 레시피 강좌를 따라가면서 백엔드를 공부하고자 합니다</p><p>그래서 예전에는 아무것도 모르는 상태로 웹사이트에 도전했는데이해가 잘안가서 철수를 했습니다.</p><p>그러나 이번에는 차곡차곡 어떤순서로 접해야 기초를 잡고 java백엔드쪽을 배울 수 있는지 여쭙고자 합니다.</p><p>기초란 어떤 순서를 통해야 프로그래밍세계에 입문할 수 있는지 정도요!</p>', 45, 2, 455, '2024-12-19 12:35:09');
