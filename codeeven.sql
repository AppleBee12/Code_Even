...
(1, 1, 1, '', 'ㄹ소', 'ㄹ소', 0, '2024-11-16 17:24:50', 'off'),
(2, 1, 6, '', 'ㄴㅇㄻ', 'ㅁㄴㅇㄹ', 0, '2024-11-16 18:30:18', 'off');
...
--
ALTER TABLE `faq`
  MODIFY `fqid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'FAQ고유번호', AUTO_INCREMENT=3;
