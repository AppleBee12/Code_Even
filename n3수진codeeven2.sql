...
(6, 3, '2024-12-22', '2024-12-22 20:07:33'),
(13, 4, '2024-12-22', '2024-12-22 15:07:32'),
(14, 2, '2024-12-22', '2024-12-22 08:06:38'),
(23, 5, '2024-12-22', '2024-12-22 15:10:49'),
(24, 3, '2024-12-23', '2024-12-22 20:36:43'),
(25, 104, '2024-12-23', '2024-12-22 20:45:11'),
(26, 3, '2024-12-27', '2024-12-26 19:45:27'),
(27, 2, '2025-01-18', '2025-01-18 14:34:47'),
(28, 2, '2025-01-19', '2025-01-18 20:05:22'),
(29, 1, '2025-01-19', '2025-01-19 14:39:33'),
(30, 3, '2025-01-19', '2025-01-19 14:40:02'),
(31, 3, '2025-01-20', '2025-01-19 15:03:39'),
(32, 3, '2025-01-21', '2025-01-21 14:33:56'),
(33, 3, '2025-01-22', '2025-01-21 15:02:39'),
(34, 3, '2025-01-23', '2025-01-22 23:07:09'),
(35, 3, '2025-01-24', '2025-01-24 14:54:42'),
(36, 3, '2025-01-25', '2025-01-24 15:01:37'),
(37, 2, '2025-01-25', '2025-01-24 15:40:49'),
(38, 1, '2025-02-02', '2025-02-01 19:37:52'),
(39, 2, '2025-02-02', '2025-02-01 19:38:06');
...
(15, 1, '코드이븐에서 쿠폰 기능이 오픈 되었습니다!', '/code_even/admin/upload/blog/co_20241112grandopen.png\r\n', '<p>코드이븐 쿠폰 기능이 오픈 되었습니다!\r\n</p><p>회원 가입시 </p><p>모든 회원에게 적용되는 쿠폰을 받으실 수 있습니다.</p>', 20, 0, 530, '2025-01-31 16:17:12');
...
(7, 11, 0, '스프링 공부 시기 + 자바', '<p>현재 백엔드를 공부해보고 싶어 JAVA를 공부중인 1학년 학생입니다!\r\n</p><p>\r\n김영한 강사님 강의 듣고 있는데 중급편 2까지 듣고 스프링 로드맵 들으면 되는 걸까요?</p><p>\r\n\r\n강의 자료에 나오는 문제 말고도 클래스,상속 같은 것에 익숙해질 수 있는 문제 사이트나?</p><p> 예시들이 있는 곳도 궁금합니다!!</p>', 15, 1, 254, '2024-12-22 17:06:26'),
(8, 12, 0, '까먹더라도 이해하는 시간을 가져야 할까요 ?', '<p>강의를 봐도 심도 있게 이해하려고 하면 진도가 안 나가고 시간이 너무 걸려요</p><p> 그렇게 해도 까먹고요 ㅠㅠ 까먹더라도 이해하는 시간을 가져야 할까요 ?</p>', 20, 0, 346, '2025-01-18 14:37:05'),
(9, 13, 0, '구글 코랩 대신 사용할 환경은 없을까요?', '<p>구글 코랩등 이런 접속 제한이 있는 환경에서 공부를 하려 합니다.\r\n</p><p>\r\n대체 환경없나요?</p>', 25, 0, 329, '2024-12-19 13:02:31'),
(10, 14, 0, '강의 수강 관련', '<p>강의를 새로 구매하기에는 비용이 부담되어 </p><p>현재 수강 중인 것 기간만료 후 연장하고 싶은데, 방법이 있을까요?</p><p>\r\n\r\n비용을 조금 추가하는 방법이라도 좋으니, 2주정도만 연장하고 싶습니다.&nbsp;</p>', 35, 0, 334, '2025-01-18 14:36:30'),
(11, 15, 0, '일단 기초적인 것부터 시작을 하려고 하는데요', '<p>일단 레시피 강좌를 따라가면서 백엔드를 공부하고자 합니다</p><p>그래서 예전에는 아무것도 모르는 상태로 웹사이트에 도전했는데 이해가 잘안가서 철수를 했습니다.</p><p>그러나 이번에는 차곡차곡 어떤순서로 접해야 기초를 잡고 java백엔드쪽을 배울 수 있는지 여쭙고자 합니다.</p><p>기초란 어떤 순서를 통해야 프로그래밍세계에 입문할 수 있는지 정도요!</p>', 45, 4, 461, '2025-01-24 16:04:15');
...
(6, 3, 'C', 7, '안녕하세요', '2024-12-22 17:06:26'),
(7, 3, 'T', 25, 'test<br />\r\n', '2024-12-22 22:47:46'),
(8, 3, 'T', 25, 'ttest', '2024-12-22 22:50:32'),
(9, 3, 'T', 25, 'ttest', '2024-12-22 22:52:10'),
(10, 3, 'T', 25, 'ttest', '2024-12-22 22:52:27'),
(11, 3, 'T', 25, 'ttestd', '2024-12-22 22:52:34'),
(12, 3, 'T', 25, 'ttestd', '2024-12-22 22:54:00'),
(13, 3, 'C', 11, 'ㅅ', '2024-12-22 22:54:09'),
(14, 3, 'T', 25, 'ㅅㄷㄴㅅㄷ', '2024-12-22 22:54:22'),
(15, 3, 'C', 19, 'g', '2025-01-24 14:55:32'),
(16, 3, 'C', 11, 'test', '2025-01-24 15:19:33'),
(17, 3, 'C', 19, 't', '2025-01-24 15:26:15'),
(18, 2, 'C', 19, 'test', '2025-01-24 15:40:56'),
(19, 3, 'T', 24, 'ㅅ', '2025-01-24 16:06:04');
...
(24, 5, '모집완료', '실제 매장에서 사용할 서비스 프론트엔드 모집!', '2024-11-25', '온/오프라인', 'vue, typescript', '단기(1~2개월)', 'https://open.kakao.com/o/A1b2Cdef3gHijk', 10, '<p>해당 서비스는 실제 매장에서 사용 예정인 만큼 개발 과정, 혹은 개발 후에도\r\n</p><p>\r\n의견을 전달 받고 수정해 가는 과정이 있을 것이라는 점 참고해주시길 바랍니다.</p><p>\r\n \r\n\r\n \r\n\r\n서비스는 크게 관리자용, 고객용 2가지로 나누어 개발이 진행될 것같으며,</p><p> 예약 및 회원 관리 서비스입니다.\r\n\r\n \r\n\r\n예약 과정에는 캘린더에 클릭 혹은 드래그를 활용하여 예약을 등록할 수 있어야 합니다.\r\n</p><p>\r\n \r\n\r\n고객용에서는 예약 가능한 시간을 확인하고, 채팅 등의 방법을 이용하여 예약할 수 있어야 합니다.\r\n</p><p>\r\n \r\n\r\n \r\n\r\n \r\n\r\n개발 순서는 관리자용 -&gt; 고객용 이며,\r\n\r\n \r\n\r\n관리자용의 구상은 마무리가 되어, 기본적인 API는 개발이 된 상황이고, </p><p>고객용 페이지는 참여하시는 분들의 의견을 전달 받고 기획을 진행할 예정입니다.\r\n</p><p><br></p><p>\r\n \r\n\r\n \r\n\r\n프로젝트 진행은\r\n</p><p>\r\n \r\n\r\n프로토타입 개발 (디자인X) -&gt; 매장 전달 -&gt; 피드백 수용 -&gt; 최종본 개발 (디자인O) </p><p>\r\n\r\n \r\n\r\n과 같은 순으로 진행하게 될 것 같습니다.\r\n</p><p>\r\n \r\n\r\n \r\n\r\n \r\n\r\n절대 큰 규모의 프로젝트가 아니기에 관리자용 전체 개발 기간은 1달 이내로 생각하고 있으며,\r\n</p><p>\r\n \r\n\r\n인원 선정은, 투자 가능한 시간과 기능 구현이 아닌, 어떻게 해야 더 효율적으로 작동할지를 </p><p>고민할 수 있는 분들을 우선으로 선정하게 될 것같습니다.</p>', 15, 2, 85, '2025-01-30 14:58:57');
...
--
ALTER TABLE `blog`
  MODIFY `post_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '게시물id', AUTO_INCREMENT=17;
...
--
ALTER TABLE `counsel`
  MODIFY `post_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '게시물id', AUTO_INCREMENT=20;
...
--
ALTER TABLE `post_comment`
  MODIFY `commid` int(11) NOT NULL AUTO_INCREMENT COMMENT '댓글id', AUTO_INCREMENT=20;
